...
class LanguageDetector(Analyzer):
    ...
    STOPWORDS = {
        "es": {"el", "la", "de", "que", "y", "a", "en", "un", "ser", "se", "no", "por", "con", "para", "lo"},
        "en": {"the", "be", "to", "of", "and", "a", "in", "that", "have", "i", "it", "for", "not", "on", "with"},
        "fr": {"le", "la", "de", "et", "un", "être", "en", "à", "que", "ne", "pas", "ce", "sur", "se", "pour"},
        "de": {"der", "die", "das", "und", "sein", "in", "ein", "zu", "haben", "von", "den", "mit", "für", "auf", "ist"},
        "it": {"il", "di", "e", "a", "che", "un", "in", "per", "non", "uno", "da", "con", "si", "lo", "la"},
        "pt": {"o", "a", "de", "que", "e", "do", "da", "em", "um", "para", "com", "não", "uma", "os", "as"}
    }
